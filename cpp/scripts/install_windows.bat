...
set TARGET_DIR=%ProgramFiles%\Network Tools 1.0.8
...
powershell -NoProfile -ExecutionPolicy Bypass -Command ^
  ...
  "$shortcut = $ws.CreateShortcut([System.IO.Path]::Combine([Environment]::GetFolderPath('Desktop'),'Network Tools 1.0.8.lnk')); " ^
